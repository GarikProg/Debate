      ...
      <div className="gobalest">
        ...
        <div className="inputGlob">
          <button
            ...
            onClick={() => setSide(thread.sideOne)}
          >
            {thread.sideOne}
          </button>
          <button
            className="sideButton"
            onClick={() => setSide(thread.sideTwo)}
          >
            {thread.sideTwo}
          </button>
          {isAuthorized ? (
            <>
              ...
              >
                {canWriteComment ? (
                  <>
                    <button className="sideButton sideButtonTwo" type="submit">
                      Punch
                    </button>{" "}
                    <input
                      placeholder="   TYPE HERE"
                      className="inputGlobInner"
                      onBlur={(e) => {
                        e.preventDefault();
                  ...
                  <div className="sideButtonCD">
                    Следующий комментарий можно написать через{" "}
                    {convertNumberToTime(coolDown)}
                  </div>
                )}
              </form>
            </>
